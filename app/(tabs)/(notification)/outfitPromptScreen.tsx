  ...
  const handleSubmitOutfit = async (): Promise<void> => {
    if (!outfitDescription.trim()) {
      Alert.alert(
        ...
        "Please describe what you'll be wearing so the user can recognize you."
      );
      return;
    }
    ...
    if (!meetingPoint.trim()) {
      Alert.alert(
        ...
        "Please specify where you'll be waiting to meet the requester."
      );
      return;
    }
    ...
    try {
        ...
        [
          {
            ...
            onPress: () => {
              ...
              router.push("/(tabs)/(notification)/notification");
            },
          },
          {
            text: "Go to Home",
      ...
      Alert.alert(
        "Error",
        "Failed to submit outfit description. Please try again."
      );
    } finally {
      ...
      <ScrollView className="flex-1 px-4 py-6">
          ...
          <View className="flex-row items-start">
            ...
            <View className="flex-1">
              ...
              <Text className="text-green-700 text-sm leading-relaxed">
                Please provide your outfit details and meeting location so{" "}
                {params?.userName || "the requester"} can easily find and
                recognize you.
              </Text>
            </View>
          </View>
          ...
          <View className="flex-row items-start">
            ...
            <View className="ml-3 flex-1">
              ...
              <Text className="text-amber-700 text-sm leading-relaxed">
                • Be as specific as possible with colors and distinctive
                features{"\n"}• Choose a well-lit, easily recognizable meeting
        ...
        <View className="mt-4 bg-gray-50 p-4 rounded-lg">
          <Text className="text-gray-600 text-sm text-center">
            ...
            a notification with your details. You'll both get each other's
            contact information and can coordinate the meetup time.
          </Text>
        </View>
      </ScrollView>
    </View>
